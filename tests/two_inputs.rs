...
fn in_place_value(#[case] test_function: fn(&mut Array<1>, Array<1>), #[case] target_function: fn(f32, f32) -> f32) {
    for i in 0..64 {
...
#[should_panic]
fn in_place_value_shape_mismatch(#[case] test_function: fn(&mut Array<1>, Array<1>)) {
...
fn in_place_ref(#[case] test_function: fn(&mut Array<1>, &Array<1>), #[case] target_function: fn(f32, f32) -> f32) {
    for i in 0..64 {
        let data1 = get_random_f32_vec(0, i);
        let data2 = get_random_f32_vec(1, i);
...
#[should_panic]
fn in_place_ref_shape_mismatch(#[case] test_function: fn(&mut Array<1>, &Array<1>)) {
    let mut array1: Array<1> = get_random_f32_vec(0, 3).into();
    let array2: Array<1> = get_random_f32_vec(1, 4).into();
    let _ = test_function(&mut array1, &array2);
}
...
fn out_of_place_value(#[case] test_function: fn(Array<1>, Array<1>) -> Array<1>, #[case] target_function: fn(f32, f32) -> f32) {
    for i in 0..64 {
        let data1 = get_random_f32_vec(0, i);
        let data2 = get_random_f32_vec(1, i);
...
#[case::div(Div::div)]
#[should_panic]
fn out_of_place_value_shape_mismatch(#[case] test_function: fn(Array<1>, Array<1>) -> Array<1>) {
...
fn out_of_place_ref(#[case] test_function: fn(&Array<1>, &Array<1>) -> Array<1>, #[case] target_function: fn(f32, f32) -> f32) {
    for i in 0..64 {
        let data1 = get_random_f32_vec(0, i);
        let data2 = get_random_f32_vec(1, i);
...
#[should_panic]
fn out_of_place_ref_shape_mismatch(#[case] test_function: fn(&Array<1>, &Array<1>) -> Array<1>) {
    let array1: Array<1> = get_random_f32_vec(0, 3).into();
    let array2: Array<1> = get_random_f32_vec(1, 4).into();
    let _ = test_function(&array1, &array2);
}
